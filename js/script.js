...
if (document_width <= 990) {
  ...
  bb1.innerHTML = "Зайти в кабинет"
  bb1.classList.add('k')
  let k = document.querySelector('.k')
  k.addEventListener('click', kabinet12)
  function kabinet12(event) {
    // Инпуты
    let input1 = document.querySelector('.input1').value;
    let input22 = document.querySelector('.input2').value;
    let adress = document.querySelector('.adress').value;
    let telefon = document.querySelector('.telefon').value;
    event.preventDefault()
    document.querySelector('.text_kabinet').innerHTML = input1
    document.querySelector('.imya').innerHTML = input1
    document.querySelector('.porol').innerHTML = input22
    document.querySelector('.nomer').innerHTML = telefon
    document.querySelector('.adres').innerHTML = adress
    cross.classList.add('active')
    big_black_box.classList.add('active')
    contan.classList.add('blc')
    setTimeout(() => {
      contan.classList.add('priv')
      cross.classList.add('top_40')
      big_black_box.classList.add('opacity_black')
    }, 100)
  }
...
let kabinet = document.querySelector('.button_header')
...
yes_zarega3.onclick = () => {
  ...
  let telefon = document.querySelector('.telefon').value;
  // Кабинет
  kabinet.addEventListener('click', kabinet12)
  function kabinet12(event) {
    event.preventDefault()
    document.querySelector('.text_kabinet').innerHTML = input1
    document.querySelector('.imya').innerHTML = input1
...
function button_header12(event) {
  event.preventDefault()
